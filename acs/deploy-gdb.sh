...
readonly PROGRAM="$2"
readonly TARGET_DIR="$3" #"/home/root/bin"
readonly TARGET_USERNAME="$4"
readonly LOCAL_BIN_DIR="$5" # "../bin"
...
ssh -t ${TARGET_USERNAME}@${TARGET_IP} "sh -c 'cd ${TARGET_DIR}; gdbserver localhost:3000 ${PROGRAM}'"
